import{I as s,s as m}from"./index-DY9sEeDM.js";async function P(S,I={}){const{windowManager:f,vfs:k,appLoader:h,loader:E}=S,b=E;if(f.windows.get("app-center")){f.focusWindow("app-center");return}const d=document.createElement("div");d.style.cssText=`
    height: 100%;
    display: flex;
