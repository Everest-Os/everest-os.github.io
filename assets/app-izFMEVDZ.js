import{I as i}from"./index-DY9sEeDM.js";async function h(n){const{windowManager:x,vfs:f,loader:b}=n,r=n.console,e=document.createElement("div");e.style.padding="20px",e.style.height="100%",e.style.display="flex",e.style.flexDirection="column",e.style.gap="15px",e.style.overflowY="auto",e.innerHTML=`
