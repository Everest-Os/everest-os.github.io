...
import{_ as x}from"./index-GtZ1kKMR.js";async function b(c,t={}){const{windowManager:p,vfs:n}=c,{IconHelper:d}=await x(async()=>{const{IconHelper:e}=await import("./index-GtZ1kKMR.js").then(r=>r.i);return{IconHelper:e}},__vite__mapDeps([0,1])),l=t.path?t.path.split(".").pop().toLowerCase():"odt";let o="doc";["xls","xlsx"].includes(l)?o="sheet":["ppt","pptx"].includes(l)&&(o="slides");const i=document.createElement("div");i.style.cssText=`
    height: 100%;
    display: flex;
